    ...
    if (state === 'idle') {
      ...
      setTimeout(() => {
        ...
        const userMessage: Message = {
          ...
          type: 'user',
          text: 'Voice message transcribed here',
          timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
        };
        ...
        setTimeout(() => {
          ...
          const aiMessage: Message = {
            ...
            type: 'ai',
            text: 'I heard your voice message. This is my response to what you said.',
            timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
          };
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      const aiMessage: Message = {
        id: (Date.now() + 1).toString(),
        type: 'ai',
        text: `I received your message: "${userMessage.text}". Here's my AI-generated response with helpful information.`,
        timestamp: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })
      };
      setMessages(prev => [...prev, aiMessage]);
